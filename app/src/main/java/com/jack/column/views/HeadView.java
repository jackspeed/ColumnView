...
public class HeadView extends View {
    ...
    private void iniTextPaint() {
        textPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DEV_KERN_TEXT_FLAG);// 设置画笔
        textPaint.setStyle(Paint.Style.FILL);//画笔设置为实心
        textPaint.setTextSize(36);// 字体大小，根据自己需求自己设定
    ...
    private void initFramePaint() {
        ...
        mPaint.setAntiAlias(true);//设置Paint抗锯齿
        mPaint.setColor(Color.WHITE);// 设置Paint的颜色  --白色
